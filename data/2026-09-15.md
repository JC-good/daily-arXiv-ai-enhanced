...
### [1] [On the Homogenization of Norm and Time Optimal Controls for Parabolic Equations with Oscillating Coefficients](https://arxiv.org/abs/2609.14622)
...
Abstract: We study homogenization of norm-optimal and time-optimal controls for a one-dimensional heat equation with rapidly oscillating periodic diffusion coefficients. The controls act on a fixed subinterval and are subject to pointwise constraints in space and time.
  We first derive final-state observability and null-controllability estimates that are uniform with respect to the oscillation scale. Combining these estimates with periodic homogenization and an abstract theory of optimal controls for parabolic systems, we prove convergence of the norm-optimal values and controls to their homogenized counterparts. We then deduce convergence of the optimal times and time-optimal controls. The controls converge weakly-star in the space of essentially bounded functions and strongly in every Lebesgue space with finite exponent, after extension to a common time interval when necessary.

</details>


### [2] [Eventual convexity for separable chance constraints with skewed generalized hyperbolic random variables](https://arxiv.org/abs/2609.15403)
...
### [3] [Deterministically Optimal Robust Exact Differentiators of Arbitrary Order](https://arxiv.org/abs/2609.15564)
...
### [4] [Revisiting Proximal Bundle Methods: Improved Rates under H{ö}lder Smoothness](https://arxiv.org/abs/2609.15806)
...
### [5] [Strategic Index Reconstitution: Differential Games, Closed-Loop Equilibria and Mean-Field Dynamics](https://arxiv.org/abs/2609.15901)
...
### [6] [On the Equivalence of Stochastic Control and Path Space Formulations for Schrödinger Bridges over Compact Connected Lie Groups](https://arxiv.org/abs/2609.13758)
...
### [7] [An Adaptive Linesearch-free Method for Monotone Variational Inequalities under Local Lipschitz Continuity](https://arxiv.org/abs/2609.15936)
...
### [8] [Interior-point proximal methods for nonsmooth optimization in Hilbert spaces with cone-ordered constraints](https://arxiv.org/abs/2609.13813)
...
### [10] [Resilient Extremum Seeking Control for Cyber-Physical Systems Under Denial-of-Service Attacks](https://arxiv.org/abs/2609.14192)
...
### [11] [Convex Pursuit-Evasion Games for Spacecraft Proximity Operations on Circular and Elliptical Orbits](https://arxiv.org/abs/2609.14337)
*Omer Burak Iskender*
...
### [12] [Optimal Sensitivity of the general Wheatstone Bridge](https://arxiv.org/abs/2609.15491)
*Michael Fischer*
...
### [13] [Predicted-Flow Control Barrier Functions for Non-Control-Affine Systems](https://arxiv.org/abs/2609.13591)
...
### [14] [Characterizing Identifiability and Generalization for Inverse Receding-Horizon Linear-Quadratic Regulator Problems](https://arxiv.org/abs/2609.14053)
...
### [15] [SafePG: Safe and Globally Optimal Reinforcement Learning with Hard Constraints](https://arxiv.org/abs/2609.14076)
...
### [16] [Angle-Based Formation Tracking of Underactuated Planar Agents](https://arxiv.org/abs/2609.14397)
...
### [17] [Safe Newton-Based Extremum Seeking for Static Maps with Delayed Output Measurements](https://arxiv.org/abs/2609.15537)
...
### [18] [MM-LMPC: Multi-Modal Learning Model Predictive Control via Mode-Specific Terminal Design and Bandit-Based Exploration](https://arxiv.org/abs/2609.15623)
...
### [19] [Computing Robustness to Sparse Diagonal Uncertainty](https://arxiv.org/abs/2609.14445)
...
### [20] [The Heavy Chain PDE: Rapid Stabilization by Backstepping](https://arxiv.org/abs/2609.14947)
*Miroslav Krstic*
...
### [21] [Real-Time Synthesis of Robust Controlled Invariant Sets for Monotone Systems](https://arxiv.org/abs/2609.14115)
...
### [22] [Seeing What the Vehicle Sees: Video-Augmented Virtual Reality for Physical Autonomous Vehicles](https://arxiv.org/abs/2609.13224)
...
### [23] [Harnessing human expertise for high-precision robotic assembly in industrialized construction: A sample-efficient installer-in-the-loop interactive reinforcement learning framework](https://arxiv.org/abs/2609.13234)
...
### [24] [Learning Manipulation-Sufficient Representations via Outcome Bottlenecks](https://arxiv.org/abs/2609.13235)
...
### [25] [Self-Evolving AI for Humanoids: Mechanisms, Safety, and Evaluation of Post-Deployment Self-Improvement](https://arxiv.org/abs/2609.13236)
...
### [26] [GzDRL: Reproducible and Scalable Deep Reinforcement Learning with Gazebo](https://arxiv.org/abs/2609.13243)
...
### [28] [Conflict-Predictive Variable Horizons in Multi-Drone Distributed Model Predictive Control](https://arxiv.org/abs/2609.13270)
...
### [29] [Extending the Speed Limit of Quadrupedal Locomotion via Refined Actuator Modeling and Adaptive Command Scheduling](https://arxiv.org/abs/2609.13289)
...
### [30] [Breaking speed scaling in quadrupedal robots via Huygens' coupled-pendulum dynamics](https://arxiv.org/abs/2609.13290)
...
### [31] [Constraint-Grounded Reinforcement Learning for Variable Impedance Control in Contact-Rich Robotic Insertion](https://arxiv.org/abs/2609.13516)
*Lin He,Min Deng*
...
### [32] [From Vision to Harvest: Benchmarking Vision-Language Models for Multi-Arm Robotic Fruit Harvesting](https://arxiv.org/abs/2609.13606)
...
### [33] [Compositional Shift Algebra: Extrapolating Mixed Robot Shifts Without Mixed Finetuning](https://arxiv.org/abs/2609.13651)
...
### [34] [Does Online Gravity Estimation Matter? Revisiting a Silent Design Split in LiDAR-Inertial Odometry](https://arxiv.org/abs/2609.13675)
...
### [35] [How to Better Train VLAs: Lessons Learned From the REAL-I Challenge at ICRA 2026](https://arxiv.org/abs/2609.13679)
...
### [36] [GROOVE: Geometry-Guided Reduction of Operational-Space Jerk in VLA Execution](https://arxiv.org/abs/2609.13695)
...
### [37] [Decentralized Multi-Robot Task Allocation Under Degraded Communication: A Benchmark of Performance, Reliability, and Computation](https://arxiv.org/abs/2609.13711)
...
### [38] [Learning In-Hand Object Reaching to General 6D Poses](https://arxiv.org/abs/2609.13761)
...
### [39] [When Do Learned Priors Help Visual Inertial Estimation? A Controlled Study of Prior Integration, Calibration, Initialization, and Backend Consistency](https://arxiv.org/abs/2609.13777)
...
### [40] [Force-Aware Reinforcement Learning with Hybrid Sensorless Force Estimation for Wheeled-Legged Loco-Manipulation](https://arxiv.org/abs/2609.13779)
...
### [41] [LePlanner: An Iterative Amortized Controller For World Models](https://arxiv.org/abs/2609.13845)
...
### [42] [What Makes an Efficient VLA? Navigating Action-Head Design, Scaling, and Latency](https://arxiv.org/abs/2609.13984)
...
### [43] [Gradient-Free Neural Hamilton-Jacobi Reachability for Scalable Safety-Critical Control](https://arxiv.org/abs/2609.14087)
...
### [44] [Vision-Force Admittance Learning for Peg Insertion into a Movable Hole](https://arxiv.org/abs/2609.14133)
...
### [45] [When Faster VLA Deployment Changes Closed-Loop Behavior: Task Success-Latency Analysis of SmolVLA Across PyTorch and ONNX Variants](https://arxiv.org/abs/2609.14146)
*Rafiqul Islam*
...
### [46] [GIFT: Glove-Inferred Force Transfer: Force-Aware Human-to-Robot Skill Transfer from a Wearable Sensing Glove to a Robot Hand Without Tactile Sensors](https://arxiv.org/abs/2609.14173)
*Tzah Sarusi*
...
### [47] [DreamSat-Bench: Development and Initial Testing of a Testbed for AI-Based Pose Estimation from 3D Reconstruction](https://arxiv.org/abs/2609.14183)
...
### [48] [Novel Ex-vivo Calf Brain Model with Integrated Sub-Skull Force Sensors to Access Simulated Neurosurgical Procedures](https://arxiv.org/abs/2609.14198)
...
### [49] [ITA-LaCAM: A Complete and Scalable TAPF Solver via Assignment-Aware Configuration-Space Search](https://arxiv.org/abs/2609.14208)
...
### [50] [Differential Realizability of Static Control Allocation in Multirotors: An Impossibility under Nonredundant Full Actuation and a Pseudoinverse Obstruction under Redundant Actuation](https://arxiv.org/abs/2609.13588)
...
### [51] [Task-Specified Active Metrological Inspection with Measurement-Steered VLA Manipulation and Deterministic Evidence Gating](https://arxiv.org/abs/2609.14219)
...
### [52] [VGFM: Expressive Robot Policies via Dense Value Guidance in Flow Matching](https://arxiv.org/abs/2609.14261)
...
### [53] [Learning Communication-Conditioned Generative Policies for Decentralized Multi-Agent Collision Avoidance](https://arxiv.org/abs/2609.14268)
*Prajwal Koirala,Mark Campbell*
...
### [54] [Multi-Task Visual Perception Network with LLM Conditioning for Autonomous Navigation](https://arxiv.org/abs/2609.14297)
...
### [55] [VLBiMan++: Expanding the Generalization Boundary of Vision-Language Anchored One-Shot Bimanual Manipulation](https://arxiv.org/abs/2609.14310)
...
### [56] [BIG-CBF: Behavior-Imagination-Guided Control Barrier Function with Shared Uncertainty for Mobile Robot Navigation](https://arxiv.org/abs/2609.14343)
...
### [57] [Orientation Control of Soft Robots via Adiabatic Spectral Submanifolds](https://arxiv.org/abs/2609.14376)
...
### [58] [Learning-Based Dynamic Obstacle Avoidance for a UAV Using Only Three Range Sensors](https://arxiv.org/abs/2609.14426)
...
### [59] [EMoG: Emotion-Modulated Gait Generation for Expressive Humanoid Locomotion](https://arxiv.org/abs/2609.14432)
...
### [60] [EcoBoat: Design and Experimental Validation of an Autonomous Body-Board Boat For Cleaning Water Bodies](https://arxiv.org/abs/2609.14450)
...
### [61] [Volumetric Harmonic Field Navigation for Quadrotors](https://arxiv.org/abs/2609.15680)
...
### [62] [Fault Diagnosis for Underwater Vehicles using Moving Horizon Estimation and Gaussian Processes](https://arxiv.org/abs/2609.14539)
...
### [63] [NavPatch: Evidence-Guided Object-Level Costmap Correction with Vision-Language Models](https://arxiv.org/abs/2609.14543)
...
### [64] [An Adaptive Fixed-Time Line-of-Sight Guidance Scheme for 3D Path Following of Underwater Vehicles: Theory and Experiment](https://arxiv.org/abs/2609.14756)
...
### [65] [Language-Grounded Semantic Target Navigation for Autonomous Surface Vehicles](https://arxiv.org/abs/2609.14558)
...
### [66] [A Personalized Dynamic Balance Evaluation Paradigm for Hip Exoskeleton-Assisted Walking under Unexpected Ground Perturbations](https://arxiv.org/abs/2609.14765)
...
### [67] [GLAM: Training a latent world model over global spatiotemporal memory for active exploration and navigation](https://arxiv.org/abs/2609.14561)
...
### [68] [Belief-Adaptive Online Autonomy for Quadrotor UAV Navigation under GNSS Degradation in Urban Environments](https://arxiv.org/abs/2609.14806)
...
### [69] [Learning Multi-Agent Task Assignment and Navigation in the Factory: from Simulation to Real Robots](https://arxiv.org/abs/2609.14567)
...
### [70] [Robotic Servo Tracking of Moving Targets with Dynamic Imitation Constraints](https://arxiv.org/abs/2609.14589)
...
### [71] [REVOLVE: An Automated Closed-Loop Framework for Evolving Robot Manipulation with Minimal Human Intervention](https://arxiv.org/abs/2609.14633)
...
### [72] [Skill Composition for Legged Robot Reinforcement Learning](https://arxiv.org/abs/2609.14647)
...
### [73] [A Novel Robot-Assisted Learning Pedagogy for Children with ASD](https://arxiv.org/abs/2609.14710)
...
### [74] [Beyond Dead Reckoning: A Point of View on Camera--DAS--GNSS Continuity in Road Tunnels](https://arxiv.org/abs/2609.14748)
...
### [75] [Language-Guided Representation Learning for Robust Cross-Sensor Material Recognition](https://arxiv.org/abs/2609.14783)
...
### [77] [Real-World Reinforcement Learning with MPC Scaffolding for Dexterous Manipulation](https://arxiv.org/abs/2609.14878)
...
### [78] [HydroMap: Probabilistic Water Surface Elevation Mapping for Semantic Scene Representation in Inland Waterways](https://arxiv.org/abs/2609.14903)
...
### [79] [Exact Feasibility Certification and Optimal Responsibility Allocation for Multi-Robot CBF Safety Filters](https://arxiv.org/abs/2609.14935)
...
### [80] [Comparing Trajectories from Positions Alone: Curvature-Based Time Alignment and Drift Error Metric](https://arxiv.org/abs/2609.14936)
...
### [81] [Two-Stage Personalized Gait Phase Estimation in Stroke Survivors During Exoskeleton-Assisted Walking: An Offline Feasibility Study](https://arxiv.org/abs/2609.14984)
...
### [82] [From Learned-Mode AV-Traffic Pairing to Planner Decisions: A Marginal-Preserving Study on Argoverse 2](https://arxiv.org/abs/2609.14997)
*Jingyu Wang*
...
### [83] [IMPACT-VLA: Interaction-aware Multimodal Propagation Attribution via Counterfactual Trajectories for Vision-Language-Action Policies](https://arxiv.org/abs/2609.15005)
...
### [84] [Atomic Motion Coordinate for Language-Steerable and Force-Responsive Manipulation](https://arxiv.org/abs/2609.15012)
...
### [85] [Steering Generative Robot Policies with Lexicographic Preferences](https://arxiv.org/abs/2609.15014)
...
### [86] [Task-Distribution-Aware Counterweight Synthesis and Constrained Co-Design for Serial Manipulators](https://arxiv.org/abs/2609.15082)
*Mohammad Abbadi*
...
### [87] [Legislating World-Model-Based Planning with Legal Reasoning](https://arxiv.org/abs/2609.15113)
...
### [88] [C$^2$Nav: Compare Before You Commit for Zero-Shot Vision-and-Language Navigation](https://arxiv.org/abs/2609.15142)
...
### [89] [LieSpline-DP: Lie-Group B-Spline Diffusion Policy for Smooth Robot Manipulation](https://arxiv.org/abs/2609.15162)
...
### [90] [HarnessVLN: Unifying Training-Free Embodied Navigation through an Agent Harness](https://arxiv.org/abs/2609.15195)
...
### [91] [PredTac: Learning Contact-Rich Manipulation with Predicted Touch](https://arxiv.org/abs/2609.15198)
...
### [92] [X-WBC: A Cross-Embodiment Foundation Model for Humanoid Whole-Body Control](https://arxiv.org/abs/2609.15213)
...
### [93] [A Vision Based Framework Integrating Attention and Action Cues for Interpretable Cognitive Workload Assessment in Human Robot Collaborative Assembly](https://arxiv.org/abs/2609.15232)
...
### [94] [Distributed Safe Cooperative Vector Field for Trajectory Curvature Constrained Multi-Robot Systems](https://arxiv.org/abs/2609.15266)
...
### [95] [Low Clearance Hinge Joint Mechanism Based on 3D Printing on Sheet Fabrication Methodology](https://arxiv.org/abs/2609.15276)
...
### [96] [Planning in the Backbone: DiffAdapterVLA for Native Continuous Trajectory Generation with Driving VLMs](https://arxiv.org/abs/2609.15322)
...
### [97] [Assistance Torque Estimation via Dynamics-Aware Optimization for Lower-Limb Exoskeleton in Complex Environments](https://arxiv.org/abs/2609.15352)
...
### [98] [Understanding User Preferences of a Slope-Aware Variable-Admittance Filter for a Robot Guide Dog](https://arxiv.org/abs/2609.15362)
...
### [99] [From Prediction to Decision: World-Model-Guided Action Selection for Continuous Pile Excavation](https://arxiv.org/abs/2609.15382)
...
### [100] [Dynamics-Informed Reinforcement Learning for Agile and Energy-Efficient Locomotion of a Monopedal Hopping Quadcopter](https://arxiv.org/abs/2609.15399)
...
### [101] [Learning to Exploit Passive Dynamics for Energy-Efficient Target Hopping of a Spring-Legged Quadcopter](https://arxiv.org/abs/2609.15447)
*Ruigang Chen,Qi Zhang,Zhicheng Zhong,Zhuorui Yun,Yizhar Or,Mingyi Liu*
...
### [102] [InterSocialBench: Benchmarking Human and LLM Preferences for Companion-Robot Social Behavior](https://arxiv.org/abs/2609.15455)
...
### [103] [P-POSEMEM: Projective Semantic Memory for Consistent Language Grounding under Pose-Graph Rewrites](https://arxiv.org/abs/2609.15475)
...
### [104] [StereoPatch: Patch-Aligned RGB-Depth Fusion for Spatial Perception in Robot Manipulation](https://arxiv.org/abs/2609.15509)
...
### [105] [DIDO: Distilling Interaction-Centric Dynamics into One-Step Denoising for World Action Models](https://arxiv.org/abs/2609.15570)
...
### [106] [An Information-Space Perspective to Scene Graph Sufficiency for Robotic Task Planning](https://arxiv.org/abs/2609.15587)
...
### [107] [Flow-Matched Motion Priors: Online Optimal-Transport Rewards for Imitation Learning](https://arxiv.org/abs/2609.15631)
...
### [108] [Tracking the Ground: Online Lidar Identification of Robot-Induced Soil Deformation in Agricultural Environments](https://arxiv.org/abs/2609.15667)
...
### [109] [Continuous Manifold-Decomposed Impedance Retargeting for Contact-Rich Imitation Learning](https://arxiv.org/abs/2609.15716)
...
### [110] [Bench2Dex: Benchmarking Visuo-Tactile Bimanual Dexterous Manipulation Across Dexterous Hands](https://arxiv.org/abs/2609.15726)
...
### [111] [JEPLO: Joint-Embedding Predictive Learning for LiDAR-Based Legged Locomotion](https://arxiv.org/abs/2609.15770)
...
### [112] [Uncertainty-Guided Sparse Refinement for Action Chunking Transformer Policies](https://arxiv.org/abs/2609.15840)
...
### [113] [DuctAM: A Duct-Assisted Quadrotor-Based Aerial Manipulator Enabling High-Force Push-and-Pull Interactions](https://arxiv.org/abs/2609.15861)
...
### [114] [WLA$^3$: World Latent Action Modeling for Semantics, Dynamics, and Kinematics](https://arxiv.org/abs/2609.15870)
...
### [115] [Goal-Oriented Communications for Physical AI: Design and Testbed](https://arxiv.org/abs/2609.15895)
...
### [116] [SlipSense: Multimodal Tactile Learning for Low-Latency and Generalized Slip Detection](https://arxiv.org/abs/2609.15910)
...
### [117] [Touch2Trace: Tactile-Driven Imitation Learning for Dexterous Cable Tracing](https://arxiv.org/abs/2609.15921)
...
### [118] [Beyond Single-Axis Testing: Paired Evaluation of Compound Robustness in Vision-Language-Action Policies](https://arxiv.org/abs/2609.15940)
...
### [119] [MessyMem: Learning-from-Doing Memory for Mobile Manipulation](https://arxiv.org/abs/2609.15976)
...
### [120] [ResSafe: Learning Safety Filtering with Residual Reinforcement Learning for Humanoids](https://arxiv.org/abs/2609.15988)
