...
### [1] [Beyond linear subspaces: Nonlinear moment matching meets quadratic manifolds](https://arxiv.org/abs/2608.19486)
...
### [2] [On the Value Function of Infinite-Horizon Optimal Control of Piecewise Affine Systems](https://arxiv.org/abs/2608.19530)
...
### [3] [Adaptive Time Windows for Discrete Adjoint Topology Optimization of Unsteady Flows](https://arxiv.org/abs/2608.19617)
...
### [4] [High-Multiplicity Flexible Job Shops: From Exact Recurrent Fluid Attainment to Structure-Guided Finite-Horizon Scheduling](https://arxiv.org/abs/2608.19711)
...
### [5] [Dangling points in area-minimizing Meissner polyhedra](https://arxiv.org/abs/2608.19747)
*Beniamin Bogosel*
...
### [6] [A Controllability Gramain Shaping with LMI Constraints under Bures--Wasserstein Distance](https://arxiv.org/abs/2608.19754)
...
### [7] [A Fixed-Penalty Linearized Augmented Lagrangian Method with Classical Multiplier Updates](https://arxiv.org/abs/2608.19847)
...
### [8] [To Control or not to Control](https://arxiv.org/abs/2608.19862)
...
### [9] [Efficient flatness-based computation of trajectories for vehicles with many trailers](https://arxiv.org/abs/2608.19915)
...
### [10] [Dual Control: On Exploration-Exploitation in Linear Systems](https://arxiv.org/abs/2608.20073)
...
### [11] [Nonlinear Controllability and the Propagation of Local Information: From the Kalman Family to Lie Brackets, Rotation Groups, and Reachable Subgroups](https://arxiv.org/abs/2608.20094)
*Philippe Mullhaupt*
...
### [12] [Worst-Case Probability Bounds for Finite-Horizon Safety under Moment Uncertainty](https://arxiv.org/abs/2608.20121)
...
### [13] [Dynamic Portfolio Optimization under CVaR Constraints](https://arxiv.org/abs/2608.20179)
...
### [14] [Direct vs. Indirect Data-Driven Control: Case-study of Switching Systems Stability](https://arxiv.org/abs/2608.20207)
...
### [15] [Directional Subdifferentials of the Value Function in Asplund Spaces](https://arxiv.org/abs/2608.20241)
...
### [16] [An end-to-end differentiable transient vapor-compression framework for automated machine sizing and unified optimal control](https://arxiv.org/abs/2608.19552)
*Sam Yang*
...
### [17] [The Calibration Illusion in Traffic Microsimulation](https://arxiv.org/abs/2608.19642)
...
### [18] [Reachability-based Time-domain Distance Protection](https://arxiv.org/abs/2608.19678)
...
### [19] [A simulation based dataset of faults and events for machine learning in power systems](https://arxiv.org/abs/2608.19777)
...
### [20] [Large reasoning models for abnormal situation management in safety-critical industrial processes](https://arxiv.org/abs/2608.19819)
*Khalid Alhazmi*
...
### [21] [Fixed-structure Gaussian Mixture Filtering with Robust Measurement Updates under Outliers](https://arxiv.org/abs/2608.19895)
...
### [22] [Harmonic Stability of Power Systems: A Control-Theoretic Definition and Assessment Criteria](https://arxiv.org/abs/2608.19975)
...
### [23] [Validation of a driver model for energy consumption simulations of road vehicles](https://arxiv.org/abs/2608.19980)
...
### [24] [Wave-Based Bilateral Teleoperation between Nonlinear Manipulators with Direct Contact Force Feedback](https://arxiv.org/abs/2608.20043)
...
### [25] [Performance-Guaranteed Reference Tracking With Power Directionality Constraints: Application to Controlled Stochastic Watersheds](https://arxiv.org/abs/2608.20120)
...
### [26] [Adaptive RBFNN Control of Uncertain Bilateral Teleoperation Systems with Delay-Dependent LMI Stability Conditions](https://arxiv.org/abs/2608.20182)
...
### [27] [Zero-Sum Power Factor Games](https://arxiv.org/abs/2608.20298)
...
### [28] [Taming the Tilt: A Unified Pilot Control Concept for Transformational eVTOL Aircraft](https://arxiv.org/abs/2608.20300)
...
### [29] [APPROVE: Visual End-User-in-the-Loop Robot Programming with LLMs](https://arxiv.org/abs/2608.19281)
...
### [30] [The Missing Touch: Spatially Distributed Tactile Feedback Brings Teleoperation Closer to Human Dexterity](https://arxiv.org/abs/2608.19372)
...
### [31] [Learning the Right Abstraction: Neural Reduced Dynamics for Complex Robot Control](https://arxiv.org/abs/2608.19375)
...
### [32] [SCAPE: Scenario-Conditioned Simulation-Augmented Policy Evaluation](https://arxiv.org/abs/2608.19425)
...
### [33] [Hybrid Feedback Sampling for Sample-Efficient Model Predictive Control](https://arxiv.org/abs/2608.19443)
...
### [34] [When Automata Meet Streams: Temporal Logic Compilation for Stream-Based Robotics Task and Motion Planning](https://arxiv.org/abs/2608.19453)
...
### [35] [Fine-Tuning VLAs with Self-Demonstrated Generative Control for Multi-Task Manipulation](https://arxiv.org/abs/2608.19490)
...
### [36] [LF-GICP: Parameter-Free Degeneracy-Aware LiDAR Odometry via a Voxel-Normal Localizability Field](https://arxiv.org/abs/2608.19522)
*Eunsoo Im*
...
### [37] [Multimodal Trajectory Planning for Surface Vehicles using Turning Circle-based Control Barrier Functions](https://arxiv.org/abs/2608.19537)
*Changyu Lee*
...
### [38] [HiTac-WAM: A Hierarchical Tactile World Action Model for Contact-Rich Robot Manipulation](https://arxiv.org/abs/2608.19574)
...
### [39] [OrthoSkillVLA: Continual Skill Learning via Gradient-Informed Skill Subspace Adaptation](https://arxiv.org/abs/2608.19589)
...
### [40] [The Verification Gap in Networked Physical AI: A Post-Semantic Communication Framework](https://arxiv.org/abs/2608.19593)
*Shunsuke Saruwatari*
...
### [41] [Magnetically Self-Sealed MR Haptic Actuator With PWM-Based Excitation and High-Fidelity Torque Control](https://arxiv.org/abs/2608.19635)
...
### [42] [What Matters for Latent Actions in Robot Learning](https://arxiv.org/abs/2608.19613)
...
### [43] [World-Model-Grounded LLM Planning for AUV and ASV Navigation Near Offshore Wind Farms](https://arxiv.org/abs/2608.19661)
...
### [44] [SAGE: Ergodic Control for Autonomous and Adaptive Inspection of Subsea Infrastructure](https://arxiv.org/abs/2608.19671)
*Markus Buchholz,Ignacio Carlucho,Yvan R. Petillot*
...
### [45] [Keeping the Franka Emika Panda alive: a ROS 2 stack with a reliable position interface](https://arxiv.org/abs/2608.19740)
...
### [46] [GOAG: Generative and Object-Agnostic Grasp Planner for Dexterous Robotic Manipulation](https://arxiv.org/abs/2608.19759)
...
### [47] [CoToGrasp: Contact-Topology-Conditioned Dexterous Grasp Synthesis via Canonical Workspace Learning](https://arxiv.org/abs/2608.19776)
...
### [48] [MILD: Tractable Terrain Modeling for Learning Improved Bipedal Locomotion on Deformable Surfaces](https://arxiv.org/abs/2608.19955)
...
### [49] [PVRA: A Pointwise Key-point Voting Framework for Robotic Assembly](https://arxiv.org/abs/2608.19968)
...
### [50] [Learning Highly Dynamic Skills Transition for Quadruped Jumping Through Constrained Space](https://arxiv.org/abs/2608.19977)
...
### [51] [Evidence-Gated Task and Motion Planning with Vision-Language Models](https://arxiv.org/abs/2608.20084)
...
### [52] [Towards Professional Tennis Styles for Humanoid Robots with Adaptive Motion Planning and Tracking](https://arxiv.org/abs/2608.20087)
...
### [53] [Planning-Oriented End-to-End Autonomous Driving: Architectures, Evaluation, and Emerging Paradigms](https://arxiv.org/abs/2608.20111)
...
### [54] [Video2DoorTraversal: Push Door Traversal via Simulated Door Twins](https://arxiv.org/abs/2608.20251)
...
### [55] [DART-S: Reachability-Audited Active-Suspension Preconditioning for Off-Road Vehicle Jumps](https://arxiv.org/abs/2608.20275)
