...
### [19] [WALL-SS: Scaling Long-horizon World Models via Next-Scale Autoregression](https://arxiv.org/abs/2608.26239)
...
### [20] [Constraint-Aware Physics-Informed Neural Networks for Static Shape Estimation of Co-Manipulative Continuum Robots](https://arxiv.org/abs/2608.26273)
...
### [21] [Dispersive Forward Tree Search for Optimal Control: Coverage, Complexity, and Computation](https://arxiv.org/abs/2608.26314)
...
### [22] [Cross-Platform Benchmark of Neural 3D Reconstruction for Autonomous Laboratory Robots](https://arxiv.org/abs/2608.26383)
...
### [23] [RTNav: Towards Real-Time Zero-Shot Object Navigation](https://arxiv.org/abs/2608.26496)
...
### [24] [Closing the Loop on the Poppy Humanoid: Bipedal Locomotion with Linear-Quadratic Control and Learned Cost Functions](https://arxiv.org/abs/2608.26505)
...
### [26] [TrapVLA: Trapping Vision-Language-Action Models in Configured Failure Modes](https://arxiv.org/abs/2608.26578)
...
### [27] [SOLO: Stable Omni-terrain Long-Horizon Perceptive Humanoid Locomotion](https://arxiv.org/abs/2608.26583)
...
### [28] [Relaxation-Aware Multimodal Sensing of Soft Gripper Driven by Structure-Perception-Learning](https://arxiv.org/abs/2608.26622)
...
### [29] [FLARE: A Failure-Aware Framework for Autonomous Correction and Recovery in Visual-Language Robotic Manipulation](https://arxiv.org/abs/2608.26645)
...
### [31] [PredVLA: A Sub-Million-Parameter Predictive-Coding Policy for Robot Manipulation](https://arxiv.org/abs/2608.26673)
...
### [32] [Residual Deep Reinforcement Learning-Based Computed Torque Control for a Cable-Driven Lower-Limb Rehabilitation Robot under Disturbances and Parametric Uncertainties](https://arxiv.org/abs/2608.26739)
...
### [33] [MeshPriorDiT: Hierarchical Modeling for Action-Conditioned Cloth Dynamics](https://arxiv.org/abs/2608.26766)
...
### [34] [Online Joint Calibration of Steering Offset and Planar LiDAR Extrinsics for Wheeled Mobile Robots](https://arxiv.org/abs/2608.26789)
...
### [35] [Rapid On-Robot Learning for Dynamic Manipulation Skills: Robot Juggling](https://arxiv.org/abs/2608.26800)
...
### [36] [CLIPPER: Replayable Shortlisted Optimization for Repeated Spatial Coverage Planning](https://arxiv.org/abs/2608.26819)
...
### [37] [TemporalFlow-VLA: Learning Physically Grounded Execution History for Long-Horizon Robot Manipulation](https://arxiv.org/abs/2608.26821)
...
### [38] [Active Surface-Driven Reconfigurable Gripper: Robust Grasping and Sequential Manipulation of Thin Objects](https://arxiv.org/abs/2608.26883)
...
### [39] [Beyond Shallow-Water Photorealism: Physically and Sensor-Grounded Simulation for Deep-Sea Robotics](https://arxiv.org/abs/2608.26888)
...
### [40] [Contact-Aided Factor-Graph Localization for Underwater Sampling](https://arxiv.org/abs/2608.26932)
...
### [41] [4DSynth: Controllable Procedural World Synthesis for Dynamic Embodied Simulation](https://arxiv.org/abs/2608.26947)
...
### [42] [Arbitrary-Order Hermite Interpolation of Rigid-Motion Jets via Hyper-Multidual Quaternions](https://arxiv.org/abs/2608.27000)
*Daniel Condurache*
...
### [43] [Riemann-1.0: An Embodied World Action Model for Physical AI](https://arxiv.org/abs/2608.27033)
...
### [44] [GRAFT: Grounded and Efficient Online Reinforcement Adaptation for Fine-Grained Robot Manipulation](https://arxiv.org/abs/2608.27079)
...
### [46] [Active sensing to characterize the heterogeneity of plant stress](https://arxiv.org/abs/2608.27088)
...
### [47] [Planning a Shared Modular Fixture Layout Across Robotic Disassembly Stages](https://arxiv.org/abs/2608.27151)
...
### [48] [Task-space model-based control of pneumatic soft actuators](https://arxiv.org/abs/2608.27186)
...
### [49] [Tensegrity Continuum Robots Enable Task-Adaptive Morphologies for Cooperative Behaviors](https://arxiv.org/abs/2608.27221)
...
### [50] [STEP: State-Aware Task Estimation and Planning with Multi-Modal LLMs for Human-Robot Collaboration](https://arxiv.org/abs/2608.27225)
...
### [51] [Embodied Scene Rearrangement Planning](https://arxiv.org/abs/2608.27371)
...
### [52] [FlashVLA: Streaming Action Decoding for Fast and Asynchronous VLA Inference](https://arxiv.org/abs/2608.27384)
...
### [53] [CLAP: Cross-Embodiment Video World Models are Zero-Shot Physical Simulators](https://arxiv.org/abs/2608.27406)
...
### [54] [Multi-Objective Planning for Healthcare Facility Resilience: Mitigate Now or Respond Later?](https://arxiv.org/abs/2608.26304)
...
### [55] [Directional Optimality Conditions for Optimization Problems in Asplund Spaces](https://arxiv.org/abs/2608.26328)
...
### [56] [Isoperimetric problems related to extremal diameter graphs in 3D: theoretical and numerical aspects](https://arxiv.org/abs/2608.26395)
*Beniamin Bogosel*
...
### [57] [Integrated Multi-Modal Transit Network Design via Dynamic Line Generation](https://arxiv.org/abs/2608.26444)
...
### [58] [Stability Analysis and Data-driven Verification via Recurrent Lyapunov Functions](https://arxiv.org/abs/2608.26447)
...
### [59] [Galerkin approximations to the space of convex bodies by polytopes in nondegenerate V-representation](https://arxiv.org/abs/2608.26615)
*Janosch Rieger*
...
### [60] [Quadratic Convexification of a Square Truncated by a Hyperbola](https://arxiv.org/abs/2608.26639)
...
### [61] [A Barrier Primal Dual Hybrid Gradient Method for Solving Linear Programming Problems](https://arxiv.org/abs/2608.26667)
...
### [62] [Optimal Parameter-Free Gradient Minimization in $\ell_p$ Geometry](https://arxiv.org/abs/2608.26688)
...
### [63] [When a Relaxed PEP Is Exact: The Sharp Queried-Gradient Rate of Nesterov's Fast Gradient Method](https://arxiv.org/abs/2608.26719)
*Yi Du*
...
### [64] [Lower Bounds for Nonconvex-PŁ Minimax Optimization](https://arxiv.org/abs/2608.26799)
*Siyu Pan,Jiajin Li*
...
### [65] [Mean-covariance turnpikes in Wasserstein distributionally robust linear-quadratic control](https://arxiv.org/abs/2608.26986)
...
### [66] [Discrete eigenvalue optimization from entropic smoothing and first-order methods](https://arxiv.org/abs/2608.27024)
...
### [68] [Classification of facial exposedness of completely positive cones over symmetric cones](https://arxiv.org/abs/2608.27062)
*Mitsuhiro Nishijima*
...
### [69] [Randomized Quasi-Gauss--Newton Methods for Solving General Nonlinear Equations](https://arxiv.org/abs/2608.27084)
...
### [70] [Co-Optimized Generation, Transmission, and Storage Expansion: System Value and Optimal Duration of Pumped-Storage Hydropower](https://arxiv.org/abs/2608.27222)
...
### [71] [Asymptotic consensus and flocking under decaying persistent excitation on rooted digraphs](https://arxiv.org/abs/2608.27263)
...
### [72] [Marine Autonomous Vehicle Fleet Scheduling to Maximise Scientific Impact](https://arxiv.org/abs/2608.27271)
...
### [73] [When MILP Beats QP: Piecewise-Linear Reformulations of Sequentially Coupled Bilinear Programs](https://arxiv.org/abs/2608.27312)
...
### [74] [UGM: A Unified Framework and New Perspectives for Accelerated Gradient Methods in Smooth and Strongly Convex Optimization](https://arxiv.org/abs/2608.27368)
