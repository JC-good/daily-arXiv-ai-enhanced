...
### [37] [Hosting Capacity Assessment of Data Centers with Voltage Ride-Through Capability in Power Systems](https://arxiv.org/abs/2609.03030)
...
### [38] [Dynamic Operational Reserve Margin Assessment from Risk-Constrained Unit Commitment States](https://arxiv.org/abs/2609.03066)
...
### [39] [Finite-Sample Limits of Entropy-Based Structure Identification in Discretized Nonlinear Systems](https://arxiv.org/abs/2609.03074)
...
### [40] [On a Gradation for Asymptotic Stability](https://arxiv.org/abs/2609.03120)
...
### [41] [A Reconfigurable Hybrid Convolutional-Fully Connected Neuromorphic Core for Biomedical Edge Inference](https://arxiv.org/abs/2609.03174)
...
### [42] [Locating Power System Oscillation Sources by Extracting Interharmonics from Synchrophasor Data](https://arxiv.org/abs/2609.03228)
*Sophia Xu,Wilsun Xu*
...
### [43] [Trajectory-Based Co-Optimization of Arrival Scheduling and Descent Path Design in the Terminal Maneuvering Area](https://arxiv.org/abs/2609.03234)
...
### [44] [Preference-Oriented Aggregation of Heterogeneous Distributed Energy Resources for Reserve Dispatch](https://arxiv.org/abs/2609.03252)
...
### [45] [Coupling-Aware Aggregation of Multi-Zone HVAC Loads under Uncertainty: A Two-level Framework](https://arxiv.org/abs/2609.03253)
...
### [46] [On the Degree of Safety: Beyond Safe or Unsafe with Control Barrier Functions](https://arxiv.org/abs/2609.03319)
...
### [47] [Traffic Congestion Control for ARZ Model with an Arbitrarily Large Input Delay](https://arxiv.org/abs/2609.03345)
...
### [48] [Taylor-Informed Indirect Adaptive Predictive Control Using Jacobian-Frozen Affine Predictors](https://arxiv.org/abs/2609.03348)
*Tam W. Nguyen*
...
### [49] [Taylor-Informed Predictive Cost Adaptive Control for Quadrotors with Online Gravity-Trim Adaptation](https://arxiv.org/abs/2609.03351)
*Tam W. Nguyen*
...
### [50] [Synchronization of directed hypergraphs with heterogeneities via dynamic coupling](https://arxiv.org/abs/2609.03698)
...
### [51] [Can Julia land on the Moon? On the development of a GNC simulation framework for the Argonaut lunar lander](https://arxiv.org/abs/2609.03843)
...
### [52] [Data-Based Clustering and Control of Similar Biological Systems](https://arxiv.org/abs/2609.03921)
...
### [53] [Quantifying Power to Voltage and Frequency Dynamics for Oscillation Propagation Assessment](https://arxiv.org/abs/2609.03929)
...
### [54] [Formation Matrix and Energy-based Control of Multi-Agent Systems](https://arxiv.org/abs/2609.04158)
...
### [55] [Structural Compatibility and Uniform Stability of Temporally Degenerate Parabolic Systems](https://arxiv.org/abs/2609.03136)
*Amadou Cissé*
...
### [56] [Gradient-Free Optimization for Matrix functions](https://arxiv.org/abs/2609.03170)
...
### [57] [An Exact Combinatorial Branch-and-Bound Algorithm for the Job Sequencing and Tool Switching Problem](https://arxiv.org/abs/2609.03219)
...
### [58] [Accelerated Prox-Level Methods for Unknown Piecewise-Smooth Optimization II: Function-constrained Optimization](https://arxiv.org/abs/2609.03251)
...
### [59] [Mean-field optimal stopping with endogenous quantile cutoffs](https://arxiv.org/abs/2609.03277)
...
### [60] [Method of successive approximations for solving integral equations of actuarial mathematics](https://arxiv.org/abs/2609.03279)
*Bogdan Norkin*
...
### [61] [A Unified Theory of H-Duality in First-Order Methods](https://arxiv.org/abs/2609.03281)
...
### [62] [On the Complexity of Recognizing SDP Exactness for the Maximum Cut Problem](https://arxiv.org/abs/2609.03508)
*Avinash Bhardwaj*
...
### [63] [Beyond Higher-Pulse Rectification: Operational Harmonic Coordination in Renewable P2H Systems](https://arxiv.org/abs/2609.03531)
...
### [64] [Well-posedness of Filtering Equations in Weighted Sobolev Spaces with Unbounded System Coefficients](https://arxiv.org/abs/2609.03549)
...
### [65] [The Traveling Tournament Problem: An Overview](https://arxiv.org/abs/2609.03612)
...
### [66] [Nash-Bargaining HalpernSGD via Limited-Memory MultiLRSGA: A Two-Phase Optimizer for Multi-Objective Learning](https://arxiv.org/abs/2609.03616)
...
### [67] [On the $Ω(n)$ SDP relaxation gap for Submodular Box-Constrained Quadratic Programming](https://arxiv.org/abs/2609.03617)
...
### [68] [Bi-objective Two Phase Transportation Problem](https://arxiv.org/abs/2609.03671)
...
### [69] [Automated Priority Rule Design for the Resource-Constrained Project Scheduling Problem: A Large Language Model-Guided Population-Based Search](https://arxiv.org/abs/2609.03754)
...
### [70] [Lifetime Profit-Maximising Co-optimisation of Multi-Service Stacking for Battery Storage](https://arxiv.org/abs/2609.03767)
...
### [71] [Data-Driven Brownian Reflection Control](https://arxiv.org/abs/2609.03870)
...
### [72] [Asymptotic Analysis of Gradient Mapping-type Stationarity Measure for the Sum of Nonconvex Nonsmooth Functions and Applications to Proximal Gradient-type Algorithms](https://arxiv.org/abs/2609.03950)
...
### [73] [Heavy-Tailed First-Order Optimization for Polyak-Łojasiewicz Condition: High-Dimensional Minimax Bounds, High-Probability Guarantee, and Fixed-Dimensional Improvements](https://arxiv.org/abs/2609.03990)
...
### [74] [DREAM: Deep-Reparametrization of Adaptive Regularization Maps for Fast Zero-Shot Self-Supervised Learning](https://arxiv.org/abs/2609.04019)
...
### [75] [Transversality Conditions for Boundary Constraints Defined by Differential Equations](https://arxiv.org/abs/2609.04084)
*Isaac M Ross*
...
### [76] [Stronger Lower Bounds for (Non-)Anytime Acceleration of Gradient Descent](https://arxiv.org/abs/2609.04032)
...
### [77] [Factor-parity Hall sets and controllability](https://arxiv.org/abs/2609.04056)
...
### [78] [Zero sum two-player differential game under three regimes](https://arxiv.org/abs/2609.04100)
...
### [79] [A Stochastic Riemannian Alternating Descent Ascent Method for Nonsmooth Composite Expectation Optimization on Riemannian Manifolds](https://arxiv.org/abs/2609.04116)
...
### [80] [Computation of Strong Solutions to Stochastic Variational Inequalities](https://arxiv.org/abs/2609.04188)
