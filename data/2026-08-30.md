...
### [1] [Production Scheduling Identification: An Inverse Optimization Approach for Industrial Load Modeling Using Smart Meter Data](https://arxiv.org/abs/2608.26485)
...
### [2] [Real-Time Operation Strategy of Virtual Power Plants With Optimal Power Disaggregation Among Heterogeneous Resources](https://arxiv.org/abs/2608.26486)
...
### [3] [Efficient Scheduling of Discrete Industrial Processes Through Continuous Modeling](https://arxiv.org/abs/2608.26487)
...
### [4] [Energy as a Concealable State in Adversarial UAV Patrolling: Formulation, an Energy-Security Threshold, and the Limits of Self-Play](https://arxiv.org/abs/2608.26518)
...
### [5] [Fusion Based Dynamic Platform Magnetic Compensation Beyond the Tolles Lawson Approach](https://arxiv.org/abs/2608.26525)
...
### [6] [Barrier Function Conformal Safety Clearance Certification with CVaR for Driving Trajectory Selection](https://arxiv.org/abs/2608.26533)
...
### [7] [Camera Calibration Using Inaccurate and Asynchronous Discrete GPS Trajectory from Drones](https://arxiv.org/abs/2608.26548)
...
### [8] [Nonlinear Model Predictive Control for Guidance Law with Target Input Estimation](https://arxiv.org/abs/2608.26551)
...
### [9] [Current-Limiting Control for Fault Ride-Through of LLC-based Solid-State Transformer in Data Centers](https://arxiv.org/abs/2608.26595)
...
### [10] [Joint Spectrum and Airspace Resource Optimization for Low-altitude Wireless Network](https://arxiv.org/abs/2608.26830)
...
### [11] [Comparative Assessment of Frequency Scans using EMT and RMS Models](https://arxiv.org/abs/2608.26851)
...
### [12] [Towards Safe Reinforcement Learning with Reduced Conservativeness: A Case Study on Drone Flight Control](https://arxiv.org/abs/2608.26852)
...
### [13] [Data-driven Koopman mode approximation: A neural power iteration algorithm](https://arxiv.org/abs/2608.26943)
...
### [14] [Energy-Neutral Coverage Optimization by Joint Deployment and Scheduling in Ambient IoT Devices with Directional Sensing](https://arxiv.org/abs/2608.26944)
...
### [15] [Mitigating Forced Oscillations in Power Systems via Data-Enabled Predictive Control](https://arxiv.org/abs/2608.26975)
...
### [16] [Threshold Pricing for Distributed Scheduling of Flexible Demands in Energy Communities](https://arxiv.org/abs/2608.27174)
...
### [17] [Why Three Phases? A Historical and Engineering Reassessment of Phase Order in AC Power Transmission](https://arxiv.org/abs/2608.27325)
*Kai Sun*
...
### [18] [Adversarially-Informed Node Criticality Identification in Power Grid Measurements](https://arxiv.org/abs/2608.27393)
...
### [19] [Multi-Objective Planning for Healthcare Facility Resilience: Mitigate Now or Respond Later?](https://arxiv.org/abs/2608.26304)
...
### [20] [Directional Optimality Conditions for Optimization Problems in Asplund Spaces](https://arxiv.org/abs/2608.26328)
...
### [21] [Isoperimetric problems related to extremal diameter graphs in 3D: theoretical and numerical aspects](https://arxiv.org/abs/2608.26395)
*Beniamin Bogosel*
...
### [22] [Integrated Multi-Modal Transit Network Design via Dynamic Line Generation](https://arxiv.org/abs/2608.26444)
...
### [23] [Stability Analysis and Data-driven Verification via Recurrent Lyapunov Functions](https://arxiv.org/abs/2608.26447)
...
### [24] [Galerkin approximations to the space of convex bodies by polytopes in nondegenerate V-representation](https://arxiv.org/abs/2608.26615)
*Janosch Rieger*
...
### [25] [Quadratic Convexification of a Square Truncated by a Hyperbola](https://arxiv.org/abs/2608.26639)
...
### [26] [A Barrier Primal Dual Hybrid Gradient Method for Solving Linear Programming Problems](https://arxiv.org/abs/2608.26667)
...
### [27] [Optimal Parameter-Free Gradient Minimization in $\ell_p$ Geometry](https://arxiv.org/abs/2608.26688)
...
### [28] [When a Relaxed PEP Is Exact: The Sharp Queried-Gradient Rate of Nesterov's Fast Gradient Method](https://arxiv.org/abs/2608.26719)
*Yi Du*
...
### [29] [Lower Bounds for Nonconvex-PŁ Minimax Optimization](https://arxiv.org/abs/2608.26799)
*Siyu Pan,Jiajin Li*
...
### [30] [Mean-covariance turnpikes in Wasserstein distributionally robust linear-quadratic control](https://arxiv.org/abs/2608.26986)
...
### [31] [Discrete eigenvalue optimization from entropic smoothing and first-order methods](https://arxiv.org/abs/2608.27024)
...
### [32] [Exact low-dimensional reformulations for regularized spectral approximation](https://arxiv.org/abs/2608.27052)
...
### [33] [Classification of facial exposedness of completely positive cones over symmetric cones](https://arxiv.org/abs/2608.27062)
*Mitsuhiro Nishijima*
...
### [34] [Randomized Quasi-Gauss--Newton Methods for Solving General Nonlinear Equations](https://arxiv.org/abs/2608.27084)
...
### [35] [Co-Optimized Generation, Transmission, and Storage Expansion: System Value and Optimal Duration of Pumped-Storage Hydropower](https://arxiv.org/abs/2608.27222)
...
### [36] [Marine Autonomous Vehicle Fleet Scheduling to Maximise Scientific Impact](https://arxiv.org/abs/2608.27271)
...
### [37] [When MILP Beats QP: Piecewise-Linear Reformulations of Sequentially Coupled Bilinear Programs](https://arxiv.org/abs/2608.27312)
...
### [38] [UGM: A Unified Framework and New Perspectives for Accelerated Gradient Methods in Smooth and Strongly Convex Optimization](https://arxiv.org/abs/2608.27368)
...
### [39] [WALL-SS: Scaling Long-horizon World Models via Next-Scale Autoregression](https://arxiv.org/abs/2608.26239)
...
### [41] [Dispersive Forward Tree Search for Optimal Control: Coverage, Complexity, and Computation](https://arxiv.org/abs/2608.26314)
...
### [42] [Cross-Platform Benchmark of Neural 3D Reconstruction for Autonomous Laboratory Robots](https://arxiv.org/abs/2608.26383)
...
### [43] [RTNav: Towards Real-Time Zero-Shot Object Navigation](https://arxiv.org/abs/2608.26496)
...
### [44] [Closing the Loop on the Poppy Humanoid: Bipedal Locomotion with Linear-Quadratic Control and Learned Cost Functions](https://arxiv.org/abs/2608.26505)
...
### [45] [Memory Anchors for Continual Robot Learning](https://arxiv.org/abs/2608.26545)
...
### [46] [TrapVLA: Trapping Vision-Language-Action Models in Configured Failure Modes](https://arxiv.org/abs/2608.26578)
...
### [47] [SOLO: Stable Omni-terrain Long-Horizon Perceptive Humanoid Locomotion](https://arxiv.org/abs/2608.26583)
...
### [48] [Relaxation-Aware Multimodal Sensing of Soft Gripper Driven by Structure-Perception-Learning](https://arxiv.org/abs/2608.26622)
...
### [49] [FLARE: A Failure-Aware Framework for Autonomous Correction and Recovery in Visual-Language Robotic Manipulation](https://arxiv.org/abs/2608.26645)
...
### [50] [Beyond the Proving Ground: Independent Public-Road Testing of Assisted Lane Change Systems using LiDAR](https://arxiv.org/abs/2608.26669)
...
### [51] [PredVLA: A Sub-Million-Parameter Predictive-Coding Policy for Robot Manipulation](https://arxiv.org/abs/2608.26673)
...
### [52] [Residual Deep Reinforcement Learning-Based Computed Torque Control for a Cable-Driven Lower-Limb Rehabilitation Robot under Disturbances and Parametric Uncertainties](https://arxiv.org/abs/2608.26739)
...
### [53] [MeshPriorDiT: Hierarchical Modeling for Action-Conditioned Cloth Dynamics](https://arxiv.org/abs/2608.26766)
...
### [54] [Online Joint Calibration of Steering Offset and Planar LiDAR Extrinsics for Wheeled Mobile Robots](https://arxiv.org/abs/2608.26789)
...
### [55] [Rapid On-Robot Learning for Dynamic Manipulation Skills: Robot Juggling](https://arxiv.org/abs/2608.26800)
...
### [56] [CLIPPER: Replayable Shortlisted Optimization for Repeated Spatial Coverage Planning](https://arxiv.org/abs/2608.26819)
...
### [57] [TemporalFlow-VLA: Learning Physically Grounded Execution History for Long-Horizon Robot Manipulation](https://arxiv.org/abs/2608.26821)
...
### [58] [Active Surface-Driven Reconfigurable Gripper: Robust Grasping and Sequential Manipulation of Thin Objects](https://arxiv.org/abs/2608.26883)
...
### [59] [Beyond Shallow-Water Photorealism: Physically and Sensor-Grounded Simulation for Deep-Sea Robotics](https://arxiv.org/abs/2608.26888)
...
### [60] [Contact-Aided Factor-Graph Localization for Underwater Sampling](https://arxiv.org/abs/2608.26932)
...
### [61] [4DSynth: Controllable Procedural World Synthesis for Dynamic Embodied Simulation](https://arxiv.org/abs/2608.26947)
...
### [62] [Arbitrary-Order Hermite Interpolation of Rigid-Motion Jets via Hyper-Multidual Quaternions](https://arxiv.org/abs/2608.27000)
*Daniel Condurache*
...
### [63] [Riemann-1.0: An Embodied World Action Model for Physical AI](https://arxiv.org/abs/2608.27033)
...
### [64] [GRAFT: Grounded and Efficient Online Reinforcement Adaptation for Fine-Grained Robot Manipulation](https://arxiv.org/abs/2608.27079)
...
### [65] [Pass the Bucket: Efficient, Robust, Local Load Balancing for Teams of Heterogeneous Robots](https://arxiv.org/abs/2608.27085)
...
### [66] [Active sensing to characterize the heterogeneity of plant stress](https://arxiv.org/abs/2608.27088)
...
### [67] [Planning a Shared Modular Fixture Layout Across Robotic Disassembly Stages](https://arxiv.org/abs/2608.27151)
...
### [68] [Task-space model-based control of pneumatic soft actuators](https://arxiv.org/abs/2608.27186)
...
### [69] [Tensegrity Continuum Robots Enable Task-Adaptive Morphologies for Cooperative Behaviors](https://arxiv.org/abs/2608.27221)
...
### [70] [STEP: State-Aware Task Estimation and Planning with Multi-Modal LLMs for Human-Robot Collaboration](https://arxiv.org/abs/2608.27225)
...
### [71] [Embodied Scene Rearrangement Planning](https://arxiv.org/abs/2608.27371)
...
### [72] [FlashVLA: Streaming Action Decoding for Fast and Asynchronous VLA Inference](https://arxiv.org/abs/2608.27384)
...
### [73] [CLAP: Cross-Embodiment Video World Models are Zero-Shot Physical Simulators](https://arxiv.org/abs/2608.27406)
